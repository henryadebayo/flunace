        ...
        child: Column(
          ...
          children: [
            ...
            Center(
                child: Text(
              "Buy Groceries\nEasily With Us",
              style: kBoldWhiteTextStyle.copyWith(fontSize: 40.0),
            )),
            Center(
                child: Text(
              "Get your groceries in as fast as one hour",
              style: kSemiBoldWhiteTextStyle.copyWith(color: Colors.white54),
            )),
            Padding(
              ...
              child: SizedBox(
                ...
                child: TextButton(
                  ...
                  child: Text("Get Started",
                      style:
                          kSemiBoldObWhiteTextStyle.copyWith(fontSize: 18.0)),
                  style: ButtonStyle(
